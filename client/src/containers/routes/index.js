...
import { Homepage, SignIn, SignUp, Dashboard, Journal, AddActivity, Blog, Pricing, About, Contacts, Privacy, Settings, Explore } from '..';
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route path="/explore" exact component={Explore} privateRoute />
